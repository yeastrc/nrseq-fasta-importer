 ...
 *
 */
public class LocalCache_Swiss_prot_DAO {

	private static final Logger log = Logger.getLogger(LocalCache_Swiss_prot_DAO.class);
	

	//  private constructor
	private LocalCache_Swiss_prot_DAO() { }
	
	/**
	 * @return newly created instance
	 */
	public static LocalCache_Swiss_prot_DAO getInstance() { 
		return new LocalCache_Swiss_prot_DAO(); 
	}
...
//		  taxonomy_id INT NULL,
		...
		try {
			...
			String msg = "Failed to select LocalCache_Swiss_prot_DTO, accession: " + accession + ", sql: " + sql;
	 ...
	 * @throws Exception
	 */
	public void saveOrUpdateOnAccession( LocalCache_Swiss_prot_DTO item  ) throws Exception {
	 ...
	 * @throws Exception
	 */
	public void saveOrUpdateOnAccession( LocalCache_Swiss_prot_DTO item, Connection dbConnection ) throws Exception {
...
//		  taxonomy_id INT NULL,
		...
		final String sql = "INSERT INTO local_cache_swiss_prot_data (accession, taxonomy_id)" +
